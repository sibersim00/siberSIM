...
const SideBar = () => {
  ...
  function isTabAllowed(tabPath, allowedTabs) {
    return allowedTabs.some((tab) => tab.path === tabPath);
  }

  // useEffect(()=>{
  //   if(menuitems && menuitems.length > 0){
  //     if(menuitems[0].Items && menuitems[0].Items.length > 0){

  //       if (!isTabAllowed(currentPath, menuitems[0].Items)) {
  //         router.push('/dashboard/'); // Redirect to a custom 404 page
  //       }
  //     }
  //   }
                        ...
                        {Item.Items &&
                          Item.Items.map((menuItem, i) => (
                            <li
                              ...
                              className={`nav-item ${
                                menuItem.type === "sub"
                                  ? menuItem?.children?.[0]?.path?.split(
                                      "/"
                                            ...
                                            >
                                              ...
                                              {childrenItem.type === "link" ? (
                                                ...
                                                location.pathname.split(
                                                  ...
                                                  <i className="angle fa fa-angle-down">
                                                    {" "}
                                                  </i>
                                                ) : (
                                                  ""
