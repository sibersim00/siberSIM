...
export const LtrtoRtl = () => {
  ...
  export function primaryOpacityVaue() {
    ...
    //get variable
    let myVarVal = localStorage.getItem("DSPprimaryColor") || localStorage.getItem("DSPdarkPrimary") || primaryColorVal;
  ...
  export function localStorageBackUp() {
    ...
    if (localStorage.getItem("DSPprimaryColor") !== null) {
      body?.classList.add("light-theme");
      document.getElementById("myonoffswitch6").checked = true;
      body?.classList.remove("dark-theme");
      html?.setProperty("--primary-bg-color", localStorage.getItem("DSPprimaryColor"));
      html?.setProperty("--primary-bg-hover", localStorage.getItem("DSPprimaryHoverColor"));
      html?.setProperty("--primary-bg-border", localStorage.getItem("DSPprimaryBorderColor"));
    }
    if (localStorage.getItem("DSPdarkPrimary") !== null) {
      body?.classList.add("dark-theme");
      body?.classList.remove("light-theme");
      html?.setProperty("--primary-bg-color", localStorage.getItem("DSPdarkPrimary"));
      html?.setProperty("--primary-bg-hover", localStorage.getItem("DSPdarkPrimary"));
      html?.setProperty("--primary-bg-border", localStorage.getItem("DSPdarkPrimary"));
    }
    ...
    if (localStorage.getItem('DSPhorizontalhover') !== null) {
      setTimeout(() => { 
    ...
    if (localStorage.getItem('DSPLtrtoRtl')) {
      LtrtoRtl()
      document.querySelector("#myonoffswitch20").checked = true;
    }
    if (localStorage.getItem('DSPdark') !== null) {
      dark()
