...
const ActionButtonRenderer = (props) => {
  ...
  const {
    ...
    terminateStudent,
    handleShowTerminateStudent,
    raiseRequest,
    handleShowRaiseRequest,
    terminationNotification,
    handleShowTerminationNotification,
  ...
  const handleTerminateStudent = (e) => {
    terminateStudent(e);
  };
  ...
  const handleTerminationNotification = (e) => {
    terminationNotification(e);
  };
  const handleaddpaticipants = (e) => {
    addparticipants(e);
  };
  const handlelistpaticipants = (e) => {
    listparticipants(e);
  };
  ...
  return (
    ...
    {handleDelete && (
      ...
      {handleShowVerifyAccount && (
        <OverlayTrigger placement="bottom" overlay={<Tooltip>Send Verification</Tooltip>}>
          <Button
            id="editBtnCommon"
            type="button"
            variant="outline-dark"
      ...
      {handleShowTerminateStudent && (
        <OverlayTrigger placement="bottom" overlay={<Tooltip>Terminate</Tooltip>}>
          <Button
            id="mapBtn"
            type="button"
            variant="outline-danger"
            className="mg-r-3"
            size="sm"
            onClick={(e) => handleTerminateStudent(propsVal?.data)}
          >
            <i
              ...
              title=""
              data-bs-placement="top"
              data-bs-original-title="Terminate"
            ></i>
          </Button>
        </OverlayTrigger>
      )}
      ...
      {handleShowRaiseRequest && (
        <OverlayTrigger placement="bottom" overlay={<Tooltip>ChatBox</Tooltip>}>
          <Button
            id="mapBtn"
            type="button"
            variant="outline-success"
            className="mg-r-3"
            size="sm"
            onClick={(e) => handleRaiseRequest(propsVal?.data)}
          >
            <i
      ...
      {handleShowTerminationNotification && (
        <OverlayTrigger placement="bottom" overlay={<Tooltip>Sent Termination Notification</Tooltip>}>
          <Button
            id="mapBtn"
            type="button"
            variant="outline-warning"
            className="mg-r-3"
            size="sm"
            onClick={(e) => handleTerminationNotification(propsVal?.data)}
          >
            <i
      ...
      {handleaddparticipants && (
        <OverlayTrigger placement="bottom" overlay={<Tooltip>Add participants</Tooltip>}>
          <Button
            id="mapBtn"
            type="button"
            ...
            className="mg-r-3"
            size="sm"
            onClick={(e) => handleaddpaticipants(propsVal?.data)}
          >
            <i
              ...
              title=""
              data-bs-placement="top"
              data-bs-original-title="Participants"
            ></i>
          </Button>
        </OverlayTrigger>
      )}
      {handlelistparticipants && (
        <OverlayTrigger placement="bottom" overlay={<Tooltip>View Participants List</Tooltip>}>
          <Button
            id="mapBtn"
            type="button"
            variant="outline-warning"
            className="mg-r-3"
            size="sm"
            onClick={(e) => handlelistpaticipants(propsVal?.data)}
          >
            <i
