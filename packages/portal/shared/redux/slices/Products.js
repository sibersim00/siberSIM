  ...
  reducers: {
    ...
    getEventsSuccess(state, action) {
      ...
      function primaryOpacityVaue() {
        ...
        //get variable
        let myVarVal =
          localStorage.getItem("DSPprimaryColor") ||
          localStorage.getItem("DSPdarkPrimary") ||
          primaryColorVal;
      ...
      switch (type) {
        ...
        case "LTR":
          ...
          document.querySelector("body").classList.remove("rtl");
          localStorage.setItem("DSPRtltoLtr", true);
          localStorage.removeItem("DSPLtrtoRtl");
          break;
        case "RTL":
          document.querySelector("body").classList.add("rtl");
          document.querySelector("body").classList.remove("ltr");
          localStorage.setItem("DSPLtrtoRtl", true);
          localStorage.removeItem("DSPRtltoLtr");
          break;
        case "RTL":
          document.querySelector("body").classList.add("rtl");
          document.querySelector("body").classList.remove("ltr");
        ...
        case "VerticalMenu":
          ...
          localStorage.setItem("DSPvertical", true);
          localStorage.removeItem("DSPhorizontal");
          localStorage.removeItem("DSPhorizontalhover");
          break;
        case "Horizontal":
          ...
          switcherArrowFn();
          localStorage.setItem("DSPhorizontal", true);
          localStorage.removeItem("DSPvertical");
          localStorage.removeItem("DSPhorizontalhover");
          break;
        case "HorizontalHoverMenu":
          ...
          Horizontalmenudefultclose();
          switcherArrowFn();
          localStorage.setItem("DSPhorizontalhover", true);
          localStorage.removeItem("DSPhorizontal");
          localStorage.removeItem("DSPvertical");
          break;
        case "LightTheme":
          ...
          primaryOpacityVaue();
          // localStorage.clear();
          localStorage.setItem("DSPLighttheme", true);
        ...
        case "dark":
          ...
          primaryOpacityVaue();
          // localStorage.clear();
          localStorage.removeItem("DSPLighttheme");
        ...
        case "resetAll":
          ...
          localStorage.removeItem("DSPLighttheme");
          localStorage.removeItem("DSPdark");
          localStorage.removeItem("DSPprimaryColor");
          localStorage.removeItem("DSPprimaryHoverColor");
          localStorage.removeItem("DSPprimaryBorderColor");
          localStorage.removeItem("DSPprimaryTransparent");
          localStorage.removeItem("DSPdarkPrimary");
          localStorage.removeItem("DSPdarkprimaryTransparent");
        ...
        case "lightPrimaryColor":
          ...
          localStorage.setItem("DSPprimaryColor", userColor);
          // to store value as opacity 0.95 we use 95
          localStorage.setItem("DSPprimaryHoverColor", userColor + 95);
          localStorage.setItem("DSPprimaryBorderColor", userColor);
          localStorage.setItem("DSPprimaryTransparent", userColor + 20);
          // localStorage.setItem("DSPprimaryTransparent", userColor + 20);
          ...
          // Removing
          document.querySelector("body")?.classList.remove("dark-theme");
          localStorage.removeItem("DSPdarkPrimaryColor");
          localStorage.removeItem("DSPdarkprimaryTransparent");
          primaryOpacityVaue();
          break;
        case "darkPrimaryColor":
          var userColor = document.getElementById("darkPrimaryColorID").value;
          localStorage.setItem("DSPdarkPrimary", userColor);
          localStorage.setItem("DSPdarkprimaryTransparent", userColor + 20);
