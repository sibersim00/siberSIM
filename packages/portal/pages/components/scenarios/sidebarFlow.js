...
import {
     getCategoriesList,getScenarioComponentListbyCategory
 } from "../../../shared/redux/slices/common/masters";
 import {  getSenarioDigramList, getSingleScenarios, clearSingleScenarios  }
     from "../../../shared/redux/slices/scenario/scenarioManage"; 
import CopyScenarioModal from "../../../shared/data/scenarios/copyScenarioModal";
 
 
const sidebarFlow = ({  setDraggedNode, scenarioId, setNodes, setEdges, setDraggedComponent }) => {
    const dispatch = useDispatch();
   const handleOneClick = (flag) => {
    setOneClick(flag);
  };
   const {
          getMasterCatListData,getComponentByCatData,
          getScenarioDigListData,getScenarioFlowchart 
      } = useSelector((state) => {
          ...
          return {
              ...
              getScenarioDigListData:   state && state.scenarioManage && state.scenarioManage.getScenarioDigListData && state.scenarioManage.getScenarioDigListData.data,
  ...
  // States to track selected values
    ...
    const handleCategoryChange = (selectedOption) => {
        ...
        dispatch(getScenarioComponentListbyCategory({
...
useEffect(() => {
  ...
  console.log('toBeDragComponent',toBeDragComponent)
     useEffect(() => {
      if (getScenarioFlowchart && getScenarioFlowchart.scenariodiagram && getScenarioFlowchart.scenariodiagram.trim()) {
