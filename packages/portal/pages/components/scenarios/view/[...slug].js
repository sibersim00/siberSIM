...
import {
    Row, Col, Card, Button, Tab, Nav
} from "react-bootstrap";
import Swal from "sweetalert2";
import { useRouter } from "next/router";
import { getSingleScenarios, clearSingleScenarios }
...
import {
    cleargetScenarioFlow, clearsaveScenarioFlow
...
const ScenarioView = () => {
    ...
    const {
        ...
        return {
            hasGetSingleScenariosSucc:
                state && state.scenarioManage && state.scenarioManage.singleScenarios && state.scenarioManage.singleScenarios.data,
                                        ...
                                        <div>
                                            <Button
                                                ...
                                                onClick={() => {
                                                    ...
                                                    dispatch(clearSingleScenarios()); dispatch(cleargetScenarioFlow());
                                                }}
                                            >
                                            ...
                                            <Tab.Container id="scenario-tabs" activeKey={activeTab} >
                                                <Row id="tabs-style-2" className="pd-l-15 pd-r-15">
                                                    ...
                                                    <Nav className="d-flex align-items-center panel-body tabs-menu-body pills bd-b pb-0 pt-1 bg-white w-100">
                                                        <Nav.Item onClick={() => setActiveTab("description")} style={{ width: "33.33%" }}>
                                                            <Nav.Link
                                                                eventKey="description"
                                                                className="masterlist"
                                                                style={{
                                                                    color: activeTab === "description" ? "#007bff" : "gray",
                                                        ...
                                                        <Nav.Item onClick={() => setActiveTab("instruction")} style={{ width: "33.33%" }}>
                                                            <Nav.Link
                                                                eventKey="instruction"
                                                                className="masterlist"
                                                                style={{
                                                                    color: activeTab === "instruction" ? "#007bff" : "gray",
                                                                    fontWeight: activeTab === "instruction" ? "bold" : "normal",
                                                                }}
                                                            >
                                                                Instruction Details
                                                            </Nav.Link>
                                                        </Nav.Item>
                                                        <Nav.Item onClick={() => setActiveTab("diagram")} style={{ width: "33.33%" }}>
                                                            <Nav.Link
                                                                eventKey="diagram"
                                                                className="masterlist"
                                                                style={{
                                                                    color: activeTab === "diagram" ? "#007bff" : "gray",
                                                        ...
                                                        <Tab.Content>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            dangerouslySetInnerHTML={{
                                                                                __html: rowValues?.scenariodescription || "—",
                                                                            }}
                                                                        />
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <Tab.Pane eventKey="instruction">
                                                                 {rowValues?.instruction_file ? (
                                                                    ...
                                                                    <p className="text-muted">No instruction PDF provided.</p>
                                                                )}
                                                            </Tab.Pane>
                                                            ...
                                                            <Tab.Pane eventKey="diagram">
                                                                ...
                                                                <ScenarioDiagram
                                                                    ...
                                                                    //         : ''
                                                                    // }
                                                                    scenariodiagram={rowValues?.scenariodiagram?.trim() ?? ''}
                                                                />
                                                            </Tab.Pane>
                                                        </Tab.Content>
                                                    </Col>
