        ...
        <Col md={12}>
          <Card className="view-component-card overflow-hidden mb-3">
            <Card.Body className="p-3">
                  ...
                  <div className="d-flex justify-content-between view-component-mb-4">
                    ...
                    <div>
                      <Button
                        ...
                        onClick={() => {
                          const backFilter = router.query.backView || "Pending";
                          push(`/customscenarios?filter=${backFilter}`);
                  ...
                  <Row className="gy-4">
                    ...
                    <Col md={3}>
                      <div className="d-flex align-items-start gap-3">
                        ...
                        <div>
                          <div className="fw-semibold text-dark mb-1">
                            {rowValues?.learner_name}
                          </div>
                          <small className="text-muted">SimUser Name</small>
                        </div>
                      </div>
                    </Col>
                  </Row>
              ...
              {rowValues?.approval_status?.toLowerCase() === "reject" && (
  <Card className="bg-white shadow-sm rounded-4 border-0 mb-4">
    <Card.Body className="p-3">
      <div className="d-flex align-items-center justify-content-between">
        <div className="d-flex align-items-center">
          <p className="text-danger mb-0 fw-semibold">Rejected Reason</p>
        </div>
      </div>
      ...
      <p className="mb-0 text-muted">
        {rowValues?.reject_reason?.trim()
          ? rowValues.reject_reason
          : "No reason provided."}
      </p>
    </Card.Body>
  </Card>
