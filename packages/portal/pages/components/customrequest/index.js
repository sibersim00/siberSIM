...
//LOADED COMPONENT
import ManageCustomComponent from "./customcomponent";
import ManageScenarios from "./customscenarios";
...
const CustomRequest = () => {
  ...
  useEffect(() => {
    if (getSubMenus && getSubMenus?.source == "/custom-request") {
          ...
          <Col md={tabOrNav ? 12 : 10}>
            ...
            {selectedSubMenu && (
              <div>
                ...
                {selectedSubMenu.source === "/customcomponent" && (
                  <ManageCustomComponent />
                )}
                {selectedSubMenu.source === "/customscenarios" && (
                  <ManageScenarios />
                )}
...
CustomRequest.layout = "Contentlayout";
