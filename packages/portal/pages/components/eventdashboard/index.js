...
const EventDashboard = () => {
    ...
    const sortedTeams = (teams || [])
        .filter((team) => team.eventuuid === selectedEventId && team.team_status === "Completed")
        .sort((a, b) => {
            const timeA = a.team_timer?.split(":").reduce((acc, t) => acc * 60 + parseInt(t), 0) || 0;
            const timeB = b.team_timer?.split(":").reduce((acc, t) => acc * 60 + parseInt(t), 0) || 0;
            return timeA - timeB;
        });
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        <div style={{ minWidth: "240px" }}>
                            <Select
                                ...
                                value={eventListOptions.find((e) => e.value === selectedEventId) || null}
                ...
                {finalSortedTeams.length === 0 && selectedEventId ? (
                    ...
                    finalSortedTeams.map((team, idx) => {
                        ...
                        return (
                            <Col md={3} key={idx}>
                                <Card
                                    className={`h-100 team-status-card ${team.team_status === "Completed"
                                        ? "card-completed"
                                    ...
                                    onMouseOut={(e) => (e.currentTarget.style.boxShadow = normalShadow)}
                                >
                                    <Card.Body className="p-3 d-flex flex-column justify-content-between align-items-center">
                                        <div className="text-center mb-3">
                                            ...
                                            <h5 className="text-dark fs-5 mb-1 mt-2">
                                                <OverlayTrigger placement="top" overlay={<Tooltip>{team.team_name}</Tooltip>}>
                                            ...
                                            <div className="d-flex justify-content-center align-items-center gap-3 my-2">
                                                {team.team_startedon && (
                                                    <OverlayTrigger placement="top" overlay={<Tooltip>Start Time – {formatTime(team.team_startedon)}</Tooltip>}>
                                                ...
                                                {team.team_completedon && (
                                                    <OverlayTrigger placement="top" overlay={<Tooltip>End Time – {formatTime(team.team_completedon)}</Tooltip>}>
                                                ...
                                                <OverlayTrigger placement="bottom" overlay={<Tooltip>{team.Mobile}</Tooltip>}>
                                                    <div className="btn btn-sm ripple bg-primary-transparent text-primary rounded-circle me-1">
                                                        <i className="fe fe-phone-call"></i>
                                                    </div>
                                                </OverlayTrigger>
                                                <OverlayTrigger placement="bottom" overlay={<Tooltip>{team.Email}</Tooltip>}>
                                                    <div className="btn btn-sm ripple bg-danger-transparent text-danger rounded-circle me-1">
                                            ...
                                            >
                                                <OverlayTrigger placement="bottom" overlay={<Tooltip>Chat</Tooltip>}>
                                                    <span className="d-inline-block position-relative">
                                                        ...
                                                        {team.unseen_message_count > 0 && (
                                                            ...
                                                            >
                                                                {team.unseen_message_count > 99 ? "99+" : team.unseen_message_count}
