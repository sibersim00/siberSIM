...
const updateSchema = joi.object({
  ...
  learner_uuid: joi.required().empty().messages({
    "any.required": `Learner is required.`,
    "number.base": `Learner must be a valid number.`,
    "number.empty": `Learner cannot be empty.`,
  }),
});
...
const mailSchema = joi.object({
  learner_uuid: joi.string().strict(true).required().messages({
    "string.base": `Learner id should be a string`,
    "string.empty": `Learner id cannot be empty`,
    "any.required": `Learner id is required.`,
  }),
});

const messages = {
  add_success: `Learner registered successfully.`,
...
const statusUpdateSchema = joi.object({
  status: joi.required().messages({
    "any.required": `Learner status is required`,
  }),
  learner_uuid: joi.string().required().empty().messages({
    "any.required": `Learner is required.`,
    "string.empty": `Learner cannot be empty.`,
  }),
});
