...
//               let [rowData] = await db.sequelize.query(`SELECT cores, memory, storage FROM components WHERE componentid = ?`,
//                 {
...
//     res[0].virtual_memory = 0;
//     res[0].storage_size = 0;
//     res[0].component_images = []; // store all images here
