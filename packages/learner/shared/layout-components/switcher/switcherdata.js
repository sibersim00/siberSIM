...
export const LtrtoRtl = () => {
  ...
  export function primaryOpacityVaue() {
    ...
    //get variable
    let myVarVal = localStorage.getItem("TbsprimaryColor") || localStorage.getItem("TbsdarkPrimary") || primaryColorVal;
  ...
  export function localStorageBackUp() {
    ...
    if (localStorage.getItem("TbsprimaryColor") !== null) {
      body?.classList.add("light-theme");
      document.getElementById("myonoffswitch6").checked = true;
      body?.classList.remove("dark-theme");
      html?.setProperty("--primary-bg-color", localStorage.getItem("TbsprimaryColor"));
      html?.setProperty("--primary-bg-hover", localStorage.getItem("TbsprimaryHoverColor"));
      html?.setProperty("--primary-bg-border", localStorage.getItem("TbsprimaryBorderColor"));
    }
    if (localStorage.getItem("TbsdarkPrimary") !== null) {
      body?.classList.add("dark-theme");
      body?.classList.remove("light-theme");
      html?.setProperty("--primary-bg-color", localStorage.getItem("TbsdarkPrimary"));
      html?.setProperty("--primary-bg-hover", localStorage.getItem("TbsdarkPrimary"));
      html?.setProperty("--primary-bg-border", localStorage.getItem("TbsdarkPrimary"));
    }
    ...
    if (localStorage.getItem('Tbshorizontalhover') !== null) {
      HorizontalHoverMenu()
      let arrowBtnFunction = () => {
        let menuWidth = document.querySelector(".hor-menu");
        let menuItems = document.querySelector(".menu-nav");
    ...
    if (localStorage.getItem('TbsLtrtoRtl')) {
      LtrtoRtl()
      document.querySelector("#myonoffswitch20").checked = true;
    }
    if (localStorage.getItem('Tbsdark') !== null) {
      dark()
