...
const slice = createSlice({
  ...
  reducers: {
    ...
    getEventsSuccess(state, action) {
      ...
      function primaryOpacityVaue() {
        let primaryColorVal = getComputedStyle(document.documentElement)
          ...
          .trim();
        let myVarVal =
          localStorage.getItem("TbsprimaryColor") ||
          localStorage.getItem("TbsdarkPrimary") ||
          primaryColorVal;
      ...
      function resetData() {
        ...
        document.querySelector("#myonoffswitch19").checked = true; 
        document.querySelector("#myonoffswitch01").checked = true; 
        ...
        document
          ...
          .classList.add("main-sidebar-body");
      ...
      switch (type) {
        ...
        case "LTR":
          ...
          document.querySelector("body").classList.remove("rtl");
          localStorage.setItem("TbsRtltoLtr", true);
          localStorage.removeItem("TbsLtrtoRtl");
          break;
        case "RTL":
          document.querySelector("body").classList.add("rtl");
          document.querySelector("body").classList.remove("ltr");
          localStorage.setItem("TbsLtrtoRtl", true);
          localStorage.removeItem("TbsRtltoLtr");
          break;
        case "RTL":
          document.querySelector("body").classList.add("rtl");
          document.querySelector("body").classList.remove("ltr");
        ...
        case "VerticalMenu":
          ...
          localStorage.setItem("Tbsvertical", true);
          localStorage.removeItem("Tbshorizontal");
          localStorage.removeItem("Tbshorizontalhover");
          break;
        case "Horizontal":
          ...
          switcherArrowFn();
          localStorage.setItem("Tbshorizontal", true);
          localStorage.removeItem("Tbsvertical");
          localStorage.removeItem("Tbshorizontalhover");
          break;
        case "HorizontalHoverMenu":
          ...
          document
            .querySelector("body")
            .classList.remove("leftmenu", "main-body");
          document
            .querySelector(".main-content")
            .classList.remove("side-content");
          document
          ...
          Horizontalmenudefultclose();
          switcherArrowFn();
          localStorage.setItem("Tbshorizontalhover", true);
          localStorage.removeItem("Tbshorizontal");
          localStorage.removeItem("Tbsvertical");
          break;
        case "LightTheme":
          ...
          primaryOpacityVaue();
          localStorage.setItem("TbsLighttheme", true);
          localStorage.removeItem("Tbsdark");
          break;
        case "dark":
          ...
          document.querySelector("html").style = "";
          primaryOpacityVaue();
          localStorage.removeItem("TbsLighttheme");
          localStorage.setItem("Tbsdark", true);
          break;
        case "LightMenu":
          document.querySelector("body").classList.remove("color-menu");
          document.querySelector("body").classList.remove("dark-menu");
        ...
        case "resetAll":
          ...
          localStorage.removeItem("TbsLighttheme");
          localStorage.removeItem("Tbsdark");
          localStorage.removeItem("TbsprimaryColor");
          localStorage.removeItem("TbsprimaryHoverColor");
          localStorage.removeItem("TbsprimaryBorderColor");
          localStorage.removeItem("TbsprimaryTransparent");
          localStorage.removeItem("TbsdarkPrimary");
          localStorage.removeItem("TbsdarkprimaryTransparent");
        ...
        case "lightPrimaryColor":
          ...
          localStorage.setItem("TbsprimaryColor", userColor);
          localStorage.setItem("TbsprimaryHoverColor", userColor + 95);
          localStorage.setItem("TbsprimaryBorderColor", userColor);
          localStorage.setItem("TbsprimaryTransparent", userColor + 20);
          ...
          document.querySelector("body")?.classList.add("light-theme");
          document.querySelector("body")?.classList.remove("dark-theme");
          localStorage.removeItem("TbsdarkPrimaryColor");
          localStorage.removeItem("TbsdarkprimaryTransparent");
          primaryOpacityVaue();
          break;
        case "darkPrimaryColor":
          var userColor = document.getElementById("darkPrimaryColorID").value;
          localStorage.setItem("TbsdarkPrimary", userColor);
          localStorage.setItem("TbsdarkprimaryTransparent", userColor + 20);
    ...
    selectEventLogin(state, action) {
      state.selectedEventLogin = action.payload;
    },
...
export function SwitcherAction(value) {
  return async (dispatch) => {
    dispatch(slice.actions.startLoading());
    try {
      dispatch(
...
export function changePrimaryColor(value) {
  return async (dispatch) => {
    dispatch(slice.actions.startLoading());
    try {
      dispatch(
...
export function darkPrimaryColor(value) {
  return async (dispatch) => {
    dispatch(slice.actions.startLoading());
    try {
      dispatch(slice.actions.getEventsSuccess(value));
    } catch (error) {
      dispatch(slice.actions.hasError(error));
    }
  };
...
export function dispatchFromLogin(value) {
  return async (dispatch) => {
    dispatch(slice.actions.startLoading());
    try {
      dispatch(slice.actions.selectEventLogin(value));
    } catch (error) {
      dispatch(slice.actions.hasError(error));
    }
  };
