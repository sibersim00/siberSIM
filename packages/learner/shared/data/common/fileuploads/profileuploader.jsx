...
const ProfileUploader = ({ ismulti, folderpath, name, acceptedFileTypes, handleUpload, fetchfiles, disabled, isDelete }) => {  
    ...
    const fetchDataAndSetFiles = async () => {
      try {
        const response = await axios.post(
          ...
          {
            headers: {
              Authorization: `Bearer ${accessTokenLearner}`, // Include the Bearer token in the headers
            },
          }
        );
