...
import {
  ...
  getInstructorList,
} from "../../redux/slices/commons/commons";
...
const ScenarioForm = (props) => {
  ...
  const { setView, rowId, oneClick, handleOneClick, approvalStatus } = props;
  ...
  const formValidation = useFormik({
    ...
    onSubmit: (data, action) => {
      ...
      if (rowValues?.custom_scenarioid) {
        ...
        dispatch(customsaveScenarios(payload));
      }
              ...
              <div className="tab-menu-heading">
                <div className="tabs-menu">
                  ...
                  >
                    ...
                    {approvalStatus?.toLowerCase() === "reject" && (
                      <Row className="mt-3">
                        <Col md={12}>
                          <Card className="shadow-sm">
                            <Card.Body className="p-3">
                              ...
                              <p className="mb-0">
                                {hasGetSingleScenariosSucc?.reject_reason
                                  ? hasGetSingleScenariosSucc.reject_reason
                                  : "No reason provided."}
                              </p>
                            </Card.Body>
