...
const ScenariosView = () => {
  ...
  console.log(
    "hasGetScenarioListSucchasGetScenarioListSuccttttttttttttttttttttttt",
    getSingleScenariosSucc
  );
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    ...
                    >
                      <Button
                        ...
                        onClick={() => {
                          // read the status from the current route
                          const filter =
                            router.query.status === "Approve"
                              ? "Approve"
                              : "Unapproved";

                          push(
                            `/customscenarios?view=${
                              backTo || "list"
                            }&filter=${filter}`
                          );
